			...
			<form name="defaultLink2" action="account.do" method="post">
				...
				<table class="search">
					...
					<tr>
						...
						<td class="paragraphbox"><select name="corporation" size="1">
								<option value="0">-選択してください-</option>
								<c:forEach var="corporation" items="${corporationList}"
									varStatus="loop">
									<option
										value="${corporation.corporationNo}/${corporation.corporationName}"
										${accountEditing.corporation.corporationNo == corporation.corporationNo ?
										'selected="selected"' : ''}>${corporation.corporationName}
									</option>
								</c:forEach>
						</select></td>
					</tr>
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/check.png"
									...
									name="AccountRegisterCheck_btn" value="" alt="確認">
							</p>
						</td>
						<td>
							<p style="position: relative;">
