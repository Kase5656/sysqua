...
<body>
	...
	<div id="scrollframe">
		<div class="form">
			...
			<h3>削除する企業情報を確認してください。</h3>
			<form name="defaultLink2" action="corporation.do" method="post">
				<input type="hidden" name="action" />
				<table class="list">
					<thead class="scrollHead">
						<tr>
							<th class="corporationName">企業名</th>
						</tr>
					</thead>
					<tbody class="scrollBody">
						<c:forEach var="corporation" items="${corporationDeleteList}">
							<tr>
								<td class="corporationName">${corporation.corporationName}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/complete.png"
									...
									name="CorporationDeleteComplete_btn" value="" alt="完了">
							</p>
						</td>
						<td>
							<p style="position: relative;">
