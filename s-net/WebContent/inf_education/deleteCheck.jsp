...
<body>
	...
	<div id="scrollframe">
		<div class="form">
			...
			<h3>
				削除する受講生情報を確認してください。<br> ※受講生情報を削除すると全ての関連するデータが削除されます※
			</h3>
			<form name="defaultLink2" action="education.do" method="post">
				...
				<table class="list">
					...
					<tbody class="scrollBody">
						<c:forEach var="education" items="${educationDeleteList}">
							<tr>
								<td class="educationName">${education.educationName}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/complete.png"
									...
									name="EducationDeleteComplete_btn" value="" alt="完了">
							</p>
						</td>
						<td>
							<p style="position: relative;">
