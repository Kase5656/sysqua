...
<body>
	...
	<div id="scrollframe">
		<div class="form">
			...
			<h3>削除する面談者情報を確認してください。</h3>
			<form name="defaultLink2" action="interview.do" method="post">
				<input type="hidden" name="action" />
				<table class="list">
					<thead class="scrollHead">
						<tr>
							<th class="interviewName">面談者氏名</th>
						</tr>
					</thead>
					<tbody class="scrollBody">
						<c:forEach var="interview" items="${interviewDeleteList}">
							<tr>
								<td class="interviewName">${interview.educationName}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/complete.png"
									...
									name="InterviewDeleteComplete_btn" value="" alt="完了">
							</p>
						</td>
						<td>
							<p style="position: relative;">
