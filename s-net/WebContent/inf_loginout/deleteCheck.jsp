					...
					<tr>
						<td>
							<p style="position: relative;">
								<input type="image" src="img/complete"
									onclick="goSubmit(this.form, this);"
									name="LoginDeleteComplete_btn" value="" alt="完了">
							</p>
						</td>
						<td>
							<p style="position: relative;">
								<input type="image" src="img/back-2.png"
									onclick="goSubmit(this.form, this);" name="_btn" value=""
									alt="戻る">
							</p>
						</td>
					</tr>
