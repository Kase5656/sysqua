				...
				<table class="search">
					...
					<tr>
						...
						<td class="paragraphbox"><input type="text"
							placeholder="例) 田中太郎" name="EducationName_txt" maxlength="100"
					...
					<tr>
						...
						<td class="paragraphbox"><input type="text"
							...
							maxlength="200" size="40" value="${education.educationKanaName}"
							required title="氏名（カナ）は200文字まで入力可能です。" /></td>
					</tr>
					<tr>
						<th class="paragraphbox">性別<font color="red">※</font></th>
					...
					<tr>
						<th class="paragraphbox">4月役割<font color="red">※</font></th>
					...
					<tr>
						<th class="paragraphbox">5月役割<font color="red">※</font></th>
					...
					<tr>
						<th class="paragraphbox">6月役割<font color="red">※</font></th>
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/check.png"
									...
									name="EducationUpdateCheck_btn" value="" alt="確認">
							</p>
						</td>
						<td>
							<p style="position: relative;">
