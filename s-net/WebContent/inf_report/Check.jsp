...
<body>
	...
	<div id="scrollframe">
		...
		<c:forEach var="comment" items="${comment}" varStatus="loop">
			<form name="defaultLink2" action="report.do" method="post">
				<input type="hidden" name="action" /> <input type="hidden"
					name="btn" /> <input type="hidden" name="reportNo"
				...
				<table class="content">
					<tr>
						...
						<c:choose>
							<c:when test="${account.accountNo == comment.fromAccountNo }">
								<td>
									<p style="position: relative;">
										<input type="image" src="img/delete.png"
											onclick="confirmFunction2(this.form, this);"
			...
			<table class="content">
				<tr>
					<td class="comment"><textarea name="comment_txt"
							class="comment" maxlength="1000" cols="40" rows="4"
