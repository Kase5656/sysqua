	...
	<div id="scrollframe">
		<div class="form">
			...
			<form name="defaultLink2" action="report.do" method="post">
				...
				<%-- <input type="hidden"
					name="reportNo" value="${report.reportNo}" /> --%>
				...
				<table class="content">
					...
					<tr>
						...
						<td class="contentsItem"><textarea name="item_txt1"
								class="item" maxlength="300" cols="40" rows="4"
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/check.png"
									...
									name="ReportUpdateCheck_btn" value="" alt="確認">
							</p>
						</td>
						<td>
							<p style="position: relative;">
								<input type="image" src="img/back-2.png"
									onclick="goSubmit(this.form, this);"
									name="CheckReportDetail_btn" value="" alt="戻る">
							</p>
						</td>
					</tr>
				</table>
