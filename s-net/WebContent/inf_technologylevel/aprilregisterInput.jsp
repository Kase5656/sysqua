						...
						<div id="global-body-left1">
							...
							<table>
								<tr>
									...
									<th class="level1">5月目標技術レベル<font color="red">※</font></th>
								</tr>
								<tr>
									<c:choose>
										<c:when test="${JspFlg == 2 }">
											<td class="levelbox1"><input type="text" placeholder=""
												name="level4_txt" maxlength="1" size="1"
												value="${technologylevel.level4}" required title="" /></td>
											<td class="levelbox1"><input type="text" placeholder=""
												name="level5Goal_txt" maxlength="1" size="1"
												value="${technologylevel.level5Goal}" required title="" /></td>
										</c:when>
										<c:otherwise>
											<td class="levelbox1"><input type="text" placeholder=""
												name="level4_txt" maxlength="1" size="1"
												value="${technologylevel.level4}" required title=""
												readonly="readonly" /></td>
											<td class="levelbox1"><input type="text" placeholder=""
												name="level5Goal_txt" maxlength="1" size="1"
												value="${technologylevel.level5Goal}" required title=""
												readonly="readonly" /></td>
										</c:otherwise>
									</c:choose>
								</tr>
							...
							<table>
								<tr>
									<th>5月目標技術レベルに対しての行動目標 <br>※箇条書きで具体的に記載
									</th>
								</tr>
								<tr>
									<c:choose>
										<c:when test="${JspFlg == 2 }">
											<td><textarea name="level4Action_txt" maxlength="300"
													cols="86" rows="10" aria-describedby=""
													aria-required="true" wrap="soft">${technologylevel.level4Action}</textarea></td>
										</c:when>
										<c:otherwise>
											<td><textarea readonly name="level4Action_txt"
											...
											<td>
												<p style="position: relative;">
													<input type="image" src="img/complete.png"
														...
														name="TechnologyAprilRegisterInput_btn" value="" alt="完了">
												</p>
											</td>
											<td>
												<p style="position: relative;">
