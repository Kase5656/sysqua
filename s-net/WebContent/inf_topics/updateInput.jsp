				...
				<table class="search">
					...
					<tr>
						...
						<td class="paragraphbox"><textarea name="TopicsContents_txt"
								...
								aria-required="true" placeholder="お知らせ内容を記載してください。">${topics.topicsContents}</textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<th class="paragraphbox">表示・非表示ステータス<font color="red">※</font></th>
						<td class="paragraphbox"><select name="deleteStatus_cmb"
							size="1">
								<c:choose>
									<c:when test="${topics.deleteFlg == 0}">
										<option value="0" selected>0</option>
									</c:when>
									<c:otherwise>
										<option value="0">0</option>
								...
								<c:choose>
									<c:when test="${topics.deleteFlg == 1}">
										<option value="1" selected>1</option>
									</c:when>
									<c:otherwise>
										<option value="1">1</option>
						...
						<td>
							<p style="position: relative;">
								<input type="image" src="img/check.png"
									...
									name="TopicsUpdateCheck_btn" value="" alt="確認">
							</p>
						</td>
						<td>
							<p style="position: relative;">
